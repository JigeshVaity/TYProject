...
import com.example.anaghafishapp.MainActivity;
...
public class verifyenterotptwo1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verifyenterotptwo1);
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onCodeSent(@NonNull String newbackendotp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(verifyenterotptwo1.this, "OTP sended successfully", Toast.LENGTH_SHORT).show();
                            }
                        }
